...
Value 数组 = ({ Value arr = create_array(); array_push(&arr, (Value){VALUE_NUMBER, .as.number = 1}); array_push(&arr, (Value){VALUE_NUMBER, .as.number = 2}); array_push(&arr, (Value){VALUE_NUMBER, .as.number = 3}); array_push(&arr, (Value){VALUE_NUMBER, .as.number = 4}); array_push(&arr, (Value){VALUE_NUMBER, .as.number = 5}); arr });
